...
let commonResource = function(objName, objID, resName){
  return {
    ...
    takeFromAnother: function(DvanotherResource, res_amount){
      return this.takeFromAndTransferTo(DvanotherResource, this, res_amount);
    },

    transferTo: function(DvanotherResource, res_amount){
      return this.takeFromAndTransferTo(this, DvanotherResource, res_amount);
    },

    exchangeTo: function(DvanotherResource, options){
      return this.takeFromAndTransferToDifferent(this, 
        DvanotherResource, options.remove_amount, options.add_amount );
    },

    takeFromAnotherAnyway: function(DvanotherResource, res_amount){
      return this.anywayTakeFromAndTransferTo(DvanotherResource, this, res_amount);
    },

    transferToAnyway: function(DvanotherResource, res_amount){
      return this.anywayTakeFromAndTransferTo(this, DvanotherResource, res_amount);
    }
...
let DvgetResourceFor = function(object, object_id, resName){
...
let DvuserResource = function(resName){
  return DvgetResourceFor('user', user.telegramid, resName);
}

let DvchatResource = function(resName){
  return DvgetResourceFor('chat', chat.chatid, resName);
}

let DvanotherUserResource = function(resName, telegramid){
  return getResourceFor('user', telegramid, resName);
}

let DvanotherChatResource = function(resName, chatid){
  return DvgetResourceFor('chat', chatid, resName);
}



publish({
  DvuserRes: DvuserResource,
  DvchatRes: DvchatResource,

  DvanotherUserRes: DvanotherUserResource,
  DvanotherChatRes: DvanotherChatResource,
